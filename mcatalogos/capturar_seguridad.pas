...
uses
  ...
  padre, ImgList, IBX.IBQuery, Db, IBX.IBCustomDataSet, IBX.IBTable, StdCtrls, DBCtrls,
      jpeg,  ExtCtrls,
     Grids, DBGrids, Buttons, IBX.IBStoredProc, Mask, System.ImageList,
  Vcl.ComCtrls, dxtree, dxdbtree;

type
  TfrmCapturar_seguridad = class(TfrmPadre)
    tlMenuAsignado: TdxDBTreeView;
    tlMenu: TdxDBTreeView;
