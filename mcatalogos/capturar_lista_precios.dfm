inherited frmCapturar_lista_precios: TfrmCapturar_lista_precios
  ...
  inherited paLienzo: TPanel
    ...
    object edMaterial: TcxButtonEdit
      ...
      Properties.OnButtonClick = edMaterialButtonClick
      TabOrder = 0
      OnKeyPress = edMaterialKeyPress
      Width = 147
    end
    object deFecha: TcxDBDateEdit
      Left = 160
      Top = 24
      TabStop = False
      DataBinding.DataField = 'FECHA'
      DataBinding.DataSource = dsFuente
      TabOrder = 1
      OnEnter = deFechaEnter
      Width = 83
    end
    object cePrecio_Minimo: TcxDBCurrencyEdit
      Left = 248
      Top = 24
      DataBinding.DataField = 'PRECIO_MINIMO'
      DataBinding.DataSource = dsFuente
      TabOrder = 2
      Width = 86
    end
    object cePrecio_Maximo: TcxDBCurrencyEdit
      Left = 340
      Top = 24
      DataBinding.DataField = 'PRECIO_MAXIMO'
      DataBinding.DataSource = dsFuente
      TabOrder = 3
  ...
  inherited TCapturar: TIBTable
    ...
    IndexFieldNames = 'ID'
    MasterFields = 'R_ID'
    MasterSource = frmExplorar_lista_precios.dsFuente
    StoreDefs = True
