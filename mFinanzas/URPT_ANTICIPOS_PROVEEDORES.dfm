object RPT_ANTICIPOS_PROVEEDORES: TRPT_ANTICIPOS_PROVEEDORES
  Left = 673
  Top = 533
  Caption = 'RPT_ANTICIPOS_PROVEEDORES'
  ClientHeight = 176
  ClientWidth = 214
  Color = clBtnFace
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object qyAnticiposEncCXP: TIBQuery
  ...
  object qyVerificarFolio: TIBQuery
    ...
    SQL.Strings = (
      'SELECT *'
      'FROM VERIF_FOLIO_ANTICIPOS_CXP(:P_ID, :P_FOLIO)')
    Left = 8
    Top = 88
    ParamData = <
      item
