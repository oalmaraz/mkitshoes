object frmCapturar_busqueda_pagos: TfrmCapturar_busqueda_pagos
  Tag = 7
  Left = 812
  Top = 443
  Caption = 'Pagos'
  ...
  object fpPadre: TPanel
    ...
    object deFecha: TDateTimePicker
      ...
      Width = 91
      Height = 21
      Date = 42264.553238923600000000
      Time = 42264.553238923600000000
      TabOrder = 0
    end
  ...
  object qyBusqueda: TIBQuery
    ...
    SQL.Strings = (
        ...
        'SELECT R_ID, R_FECHA, R_CAJA, R_CAJA_NOMBRE, R_CAJERO, R_CAJERO_' +
        'NOMBRE, R_FOLIO, R_GRANTOTAL, R_CAMBIO, R_ESTATUS ESTATUS'
      'FROM BUSCAR_PAGOS(:P_FECHA, :P_CAJA, :P_CAJERO)')
    Left = 128
    Top = 336
    ParamData = <
      item
