...
begin
  ...
  begin
     spDEL_PARTIDA_COTIZACION.ParamByName('P_ID').AsString := qyPartidas.FieldByName('R_ID').AsString;
...
//                 deCliente.SetSelection(deCliente { Length(deCliente.Text),Length(deCliente.Text),false} );
              end;
           end
           else
              begin
