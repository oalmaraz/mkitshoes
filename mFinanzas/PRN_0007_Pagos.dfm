inherited frmPRN_0007: TfrmPRN_0007
  Left = 567
  Top = 163
  ...
  inherited fpPadre: TPanel
    ...
    object deFecha: TDateTimePicker
      ...
      Width = 91
      Height = 21
      Date = 42264.575736585600000000
      Time = 42264.575736585600000000
      TabOrder = 1
    end
  ...
  object dsCXCPagos: TDataSource
    DataSet = qyCXCPagos
    Left = 184
    Top = 104
  end
  object dsCXCPagosDet: TDataSource
    DataSet = qyCXCPagosDet
    Left = 184
    Top = 136
  end
  ...
  object qyBusqueda: TIBQuery
    ...
    SQL.Strings = (
      'SELECT *'
        ...
        'FROM BUSQUEDA_FOLIO_PAGO(:P_FOLIO, :P_FECHA, :P_FECHA, :P_CAJA, ' +
        ':P_ALMACEN)')
    Left = 216
    Top = 104
    ParamData = <
    ...
    object qyBusquedaR_FOLIO_PAGO: TIntegerField
      FieldKind = fkInternalCalc
    ...
    object qyBusquedaR_TOTAL: TFloatField
      FieldKind = fkInternalCalc
      FieldName = 'R_TOTAL'
      ReadOnly = True
    end
