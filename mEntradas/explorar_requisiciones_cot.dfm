inherited frmExplorar_requisicion_cotizaciones: TfrmExplorar_requisicion_cotizaciones
  ...
  inherited dgExplorar: TcxGrid
    ...
    inherited dgExplorarDBTableView1: TcxGridDBTableView
      ...
      object dgExplorarDBTableView1COMPRA_MINIMA: TcxGridDBColumn
        DataBinding.FieldName = 'COMPRA_MINIMA'
      end
      object dgExplorarDBTableView1DESCUENTO_PORC: TcxGridDBColumn
        DataBinding.FieldName = 'DESCUENTO_PORC'
      end
