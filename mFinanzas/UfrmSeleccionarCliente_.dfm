object frmSeleccionarCliente_: TfrmSeleccionarCliente_
  Left = 548
  Top = 531
  ...
  object qyVendedor: TIBQuery
    ...
    object qyVendedorTABULADOR: TIntegerField
      FieldName = 'TABULADOR'
      Origin = 'SUJETOS_VENDEDORES.TABULADOR'
    end
    object qyVendedorTABULADOR_IMPORTADOS: TIntegerField
      FieldName = 'TABULADOR_IMPORTADOS'
      Origin = 'SUJETOS_VENDEDORES.TABULADOR_IMPORTADOS'
    end
    object qyVendedorTABULADOR_EXTEMPORANEOS: TIntegerField
      FieldName = 'TABULADOR_EXTEMPORANEOS'
      Origin = 'SUJETOS_VENDEDORES.TABULADOR_EXTEMPORANEOS'
    end
    object qyVendedorTABULADOR_SIN_OCOMPRA: TIntegerField
      FieldName = 'TABULADOR_SIN_OCOMPRA'
      Origin = 'SUJETOS_VENDEDORES.TABULADOR_SIN_OCOMPRA'
    end
