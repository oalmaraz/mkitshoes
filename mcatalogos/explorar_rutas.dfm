inherited frmExplorar_rutas: TfrmExplorar_rutas
  ...
  inherited dgExplorar: TcxGrid
    ...
    inherited dgExplorarDBTableView1: TcxGridDBTableView
      ...
      object dgExplorarDBTableView1R_TRANSPORTISTA_CLAVE: TcxGridDBColumn
        DataBinding.FieldName = 'R_TRANSPORTISTA_CLAVE'
      end
      object dgExplorarDBTableView1R_TRANSPORTISTA_NOMBRE: TcxGridDBColumn
        DataBinding.FieldName = 'R_TRANSPORTISTA_NOMBRE'
      end
    end
  end
