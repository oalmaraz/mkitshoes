inherited frmPRN_0011: TfrmPRN_0011
  Left = 346
  Top = 68
  ...
  inherited fpPadre: TPanel
    ...
    object deFecha: TDateTimePicker
      ...
      Width = 91
      Height = 21
      Date = 42265.618900463000000000
      Time = 42265.618900463000000000
      TabOrder = 0
    end
  ...
  object qyCheques: TIBQuery
    Database = dmIBModulo.ibSistema
    Transaction = dmIBModulo.ibSistemaTransaccion
    OnCalcFields = qyChequesCalcFields
    BufferChunks = 1000
    CachedUpdates = False
    ParamCheck = True
    SQL.Strings = (
      'select *'
      'from buscar_cheques(:P_FECHA, :P_ESTATUS)')
    Left = 24
    Top = 160
    ParamData = <
      item
    ...
    object qyChequesR_TIPO: TIBStringField
    ...
    object qyChequesR_AUTORIZACION: TIBStringField
      FieldKind = fkInternalCalc
    ...
    object qyChequesR_CLIENTE: TIntegerField
      FieldKind = fkInternalCalc
      FieldName = 'R_CLIENTE'
      ReadOnly = True
    end
    object qyChequesR_CLIENTE_NOMBRE: TIBStringField
      FieldKind = fkInternalCalc
      FieldName = 'R_CLIENTE_NOMBRE'
      ReadOnly = True
      Size = 100
    end
    object qyChequesR_EXTENSION: TIntegerField
      FieldKind = fkInternalCalc
      FieldName = 'R_EXTENSION'
      ReadOnly = True
    end
    object qyChequesR_EXTENSION_NOMBRE: TIBStringField
      FieldKind = fkInternalCalc
    ...
    object qyChequesR_ID_REFERENCIA: TIntegerField
      FieldKind = fkInternalCalc
    ...
    object qyChequesESTATUS: TIBStringField
      FieldKind = fkInternalCalc
      FieldName = 'ESTATUS'
      ReadOnly = True
    end
    object qyChequestotalCobrado: TFloatField
