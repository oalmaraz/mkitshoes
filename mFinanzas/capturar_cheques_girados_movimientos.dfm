object frmCapturar_ChequesGiradosMovimientos: TfrmCapturar_ChequesGiradosMovimientos
  Tag = 15
  Left = 378
  Top = 284
  ActiveControl = deFecha
  Caption = 'Cheques Girados Movimientos'
  ClientHeight = 0
  ClientWidth = 124
  Color = clBtnFace
  ...
  object fpPadre: TPanel
    ...
    object deFecha: TDateTimePicker
      ...
      Width = 91
      Height = 21
      Date = 42265.600726990700000000
      Time = 42265.600726990700000000
      TabOrder = 0
    end
  ...
  object qyBusqueda: TIBQuery
    ...
    SQL.Strings = (
      'SELECT *'
      'FROM BUSCAR_CHEQUES_GIRADOS(:P_FECHA,"Todos")')
    Left = 128
    Top = 336
    ParamData = <
      item
    ...
    object qyBusquedaR_PROVEEDOR: TIntegerField
      FieldKind = fkInternalCalc
      FieldName = 'R_PROVEEDOR'
      ReadOnly = True
    end
    object qyBusquedaR_PROVEEDOR_NOMBRE: TIBStringField
      FieldKind = fkInternalCalc
    ...
    object qyBusquedaR_FECHA_APLICACION: TDateTimeField
      FieldKind = fkInternalCalc
    ...
    object qyBusquedaR_BANCO: TIntegerField
      FieldKind = fkInternalCalc
      FieldName = 'R_BANCO'
      ReadOnly = True
    end
    object qyBusquedaR_BANCO_NOMBRE: TIBStringField
      FieldKind = fkInternalCalc
      FieldName = 'R_BANCO_NOMBRE'
      ReadOnly = True
      Size = 100
    end
    object qyBusquedaR_OBSERVACIONES: TBlobField
      FieldKind = fkInternalCalc
  ...
  object spP_CHEQUES_OUT_QUIEN: TIBStoredProc
    Database = dmIBModulo.ibSistema
    Transaction = dmIBModulo.ibSistemaTransaccion
    StoredProcName = 'P_CHEQUES_OUT_QUIEN'
    Left = 256
    Top = 336
    ParamData = <
      item
