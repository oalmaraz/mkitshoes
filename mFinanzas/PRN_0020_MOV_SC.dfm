inherited frmPRN_0020: TfrmPRN_0020
  Left = 379
  Top = 190
  Caption = 'PRN_0020'
  ClientHeight = 351
  ...
  inherited fpPadre: TPanel
    ...
    object deFecha: TDateTimePicker
      ...
      Width = 91
      Height = 21
      Date = 42265.647290752300000000
      Time = 42265.647290752300000000
      TabOrder = 0
    end
  ...
  object dsCheques: TDataSource
    DataSet = qyMovimientosResumen
    Left = 40
    Top = 176
  end
  object qyMovimientosResumen: TIBQuery
    Database = dmIBModulo.ibSistema
    Transaction = dmIBModulo.ibSistemaTransaccion
    OnCalcFields = qyMovimientosResumenCalcFields
    BufferChunks = 1000
    CachedUpdates = False
    ParamCheck = True
    SQL.Strings = (
      'SELECT SUM(R_MONTO) R_MONTO, R_MONEDA_DESCRIPCION'
      'FROM BUSCAR_MOV_SC(:P_FECHA, :P_ESTATUS)'
      'WHERE R_ESTATUS = "Afectado"'
      'GROUP BY R_MONEDA_DESCRIPCION')
    Left = 8
    Top = 240
    ParamData = <
      item
    ...
    object qyMovimientosResumenR_MONTO: TFloatField
      FieldName = 'R_MONTO'
    end
    object qyMovimientosResumenR_MONEDA_DESCRIPCION: TIBStringField
