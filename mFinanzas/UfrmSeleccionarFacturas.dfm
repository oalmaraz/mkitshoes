object frmSeleccionarFacturas: TfrmSeleccionarFacturas
  Left = 376
  Top = 168
  ...
  object qyBusqueda: TIBQuery
    ...
    SQL.Strings = (
        ...
        'SELECT F.ID, F.SERIE_FACTURA, F.CONSECUTIVO, F.CLAVE, F.NOMBRE, ' +
        'F.DESCUENTO_GLOBAL_PORC, F.GRANTOTAL, F.ESTATUS, F.CLIENTE, F.EX' +
        'TENSION'
      'FROM FACTURAS F')
    Left = 192
    Top = 128
    ...
    object qyBusquedaSERIE_FACTURA: TIBStringField
    ...
    object qyBusquedaDESCUENTO_GLOBAL_PORC: TFloatField
      ...
      Origin = 'FACTURAS.DESCUENTO_GLOBAL_PORC'
      DisplayFormat = '##0.00 %'
    end
