object frmCapturar_busqueda_cheques: TfrmCapturar_busqueda_cheques
  Tag = 8
  Left = 502
  Top = 262
  ActiveControl = deFecha
  Caption = 'Busqueda Cheques'
  ClientHeight = 0
  ClientWidth = 124
  Color = clBtnFace
  ...
  object fpPadre: TPanel
    ...
    object deFecha: TDateTimePicker
      ...
      Width = 91
      Height = 21
      Date = 42265.623299328700000000
      Time = 42265.623299328700000000
      TabOrder = 0
    end
  ...
  object qyBusqueda: TIBQuery
    ...
    SQL.Strings = (
      'select *'
      'from buscar_cheques(:P_FECHA,"Todos")')
    Left = 128
    Top = 336
    ParamData = <
      item
    ...
    object qyBusquedaR_AUTORIZACION: TIBStringField
      FieldKind = fkInternalCalc
      FieldName = 'R_AUTORIZACION'
      ReadOnly = True
    end
