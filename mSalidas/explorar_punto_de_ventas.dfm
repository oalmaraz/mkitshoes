inherited frmExplorar_punto_de_ventas: TfrmExplorar_punto_de_ventas
  ...
  inherited dgExplorar: TcxGrid [1]
    ...
    inherited dgExplorarDBTableView1: TcxGridDBTableView
      ...
      object dgExplorarDBTableView1R_MONEDA_DESCRIPCION: TcxGridDBColumn
        DataBinding.FieldName = 'R_MONEDA_DESCRIPCION'
      end
      object dgExplorarDBTableView1R_FOLIO_ALMACEN: TcxGridDBColumn
        DataBinding.FieldName = 'R_FOLIO_ALMACEN'
      end
      object dgExplorarDBTableView1R_FOLIO_GENERAL: TcxGridDBColumn
        DataBinding.FieldName = 'R_FOLIO_GENERAL'
      end
      object dgExplorarDBTableView1R_CLIENTE_C: TcxGridDBColumn
        DataBinding.FieldName = 'R_CLIENTE_C'
      end
      object dgExplorarDBTableView1R_CLIENTE_T: TcxGridDBColumn
        DataBinding.FieldName = 'R_CLIENTE_T'
      end
    end
  end
