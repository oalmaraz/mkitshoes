...
uses
  ...
  DBCtrls,
  IBX.IBQuery, Mask, Classes, ExtCtrls,   Buttons,
  IBX.IBStoredProc, IBX.IBTable, IBX.IBCustomDataSet, Dialogs, cxGraphics,
  cxControls, cxLookAndFeels, cxLookAndFeelPainters, cxContainer, cxEdit,
  System.ImageList, cxTextEdit, cxMaskEdit, cxButtonEdit, cxDropDownEdit,
  cxCalendar, cxDBEdit, cxCustomData, cxStyles, cxTL, cxTLdxBarBuiltInMenu,
  cxInplaceContainer, cxDBTL, cxTLData, cxFilter, cxData, cxDataStorage,
...
type
  TfrmCapturar_Ordenes_de_Compras = class(TfrmCapturarMDI)
    ...
    tlCotizacionescxDBTreeListColumn1: TcxDBTreeListColumn;
    ...
    procedure dgPartidasFEButtonClick(Sender: TObject;
      AbsoluteIndex: Integer);
    procedure edProveedorPropertiesButtonClick(Sender: TObject;
...
uses filectrl, explorar_ordenes_de_compras, reglas_de_negocios, IBModulo, IBData, IBX.IB,
...
procedure TfrmCapturar_Ordenes_de_Compras.MarcoMateriales1edMaterialKeyPress(
...
begin
  ...
  if Key = #13 then
  begin
    edProveedorPropertiesButtonClick(Sender, 0);
  end;
end;

procedure TfrmCapturar_Ordenes_de_Compras.edProveedorPropertiesButtonClick(
