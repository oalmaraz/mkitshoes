inherited frmCapturar_seguridad: TfrmCapturar_seguridad
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object tlMenuAsignado: TdxDBTreeView [0]
    Left = 8
    Top = 113
    Width = 209
    Height = 330
  ...
  object TUsuarios: TIBTable
    ...
    IndexDefs = <
      ...
      item
        Name = 'RDB$FOREIGN1047'
        Fields = 'UBICACION_ZONA'
      end>
    StoreDefs = True
    ...
    object TUsuariosSUJETO: TIntegerField
      FieldName = 'SUJETO'
      Origin = 'SUJETOS_USUARIOS.SUJETO'
    end
