...
uses
  ...
  explorarMDI, IBX.IBStoredProc,  Db,
  Menus,   IBX.IBCustomDataSet, IBX.IBQuery,  StdCtrls,
       Mask, DBCtrls,
       jpeg,
  ExtCtrls,    IBData,
       ComCtrls, Grids,
  DBGrids, Buttons, cxGraphics, cxControls, cxLookAndFeels,
...
type
  TfrmExplorar_lista_precios = class(TfrmExplorarMDI)
    ...
    dgExplorarDBTableView1R_MATERIAL_ID: TcxGridDBColumn;
    ...
    dgExplorarDBTableView1R_PRECIO_MINIMO: TcxGridDBColumn;
    dgExplorarDBTableView1R_PRECIO_MAXIMO: TcxGridDBColumn;
    dgExplorarDBTableView1R_COSTO: TcxGridDBColumn;
    dgExplorarDBTableView1R_FUCOMPRA: TcxGridDBColumn;
    dgExplorarDBTableView1R_X_CAJA: TcxGridDBColumn;
    dgExplorarDBTableView1R_ESTATUS: TcxGridDBColumn;
    dgExplorarDBTableView1R_CBARRAS: TcxGridDBColumn;
...
begin
  ...
  begin
     ...
     begin
        ...
        dgExplorarDBTableView1.DataController.DataSource.DataSet.First;
        edPrecio.Clear;
     end;
  end;
end;
