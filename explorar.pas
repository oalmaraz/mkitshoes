...
uses
  ...
  IBX.IBCustomDataSet, IBX.IBQuery, Mask, DBCtrls,
   jpeg,  ExtCtrls,
    ComCtrls, Buttons, Grids, DBGrids, cxGraphics, cxControls, cxLookAndFeels,
...
type
  TfrmExplorar = class(TfrmHijo)
    ...
    buExpHoy: TBitBtn;
    dgExplorarLevel1: TcxGridLevel;
    dgExplorarDBTableView1: TcxGridDBTableView;
...
begin
   ...
   begin
      ...
      quien;
      FieldSearch := dgExplorarDBTableView1.Columns[awrQuien].DataBinding.FieldName;
   end;
end;
...
begin
  ...
  if FForma <> '' then
     forma(FForma , dgExplorarDBTableView1   )
  else
  begin
...
procedure TfrmExplorar.dgExplorarDBTableView1DblClick(Sender: TObject);
begin
  inherited;
  if ibPantalla.Enabled then
     ibPantalla.Click;
...
begin
  inherited;
  dgExplorarDBTableView1.DataController.DataSource.DataSet.Prior;
end;
...
begin
  inherited;
  dgExplorarDBTableView1.DataController.DataSource.DataSet.Last;
end;
