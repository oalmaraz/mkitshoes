...
uses
  ...
  DBGrids, System.ImageList, cxGraphics, cxControls, cxLookAndFeels,
  cxLookAndFeelPainters, cxStyles, cxGrid, Vcl.ComCtrls, dxtree, dxdbtree,
...
type
  TfrmCapturar_entidad_geografica = class(TfrmCapturarMDI)
    ...
    dxDBGrid1Level1: TcxGridLevel;
    dxDBGrid1DBTableView1: TcxGridDBTableView;
    dxDBGrid1DBTableView1Column2: TcxGridDBColumn;
    {
