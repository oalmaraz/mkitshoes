inherited frmCapturar_vendedores: TfrmCapturar_vendedores
    ...
    inherited pcSujetos: TPageControl
      ...
      inherited tsDomicilio: TTabSheet
        ...
        inherited fpDomicilio: TPanel
          ...
          ExplicitWidth = 730
          ExplicitHeight = 289
          inherited leCiudades: TDBLookupComboBox
            KeyField = 'R_ID'
            ListField = 'R_DESCRIPCION'
            ListSource = dsCiudades
          end
          inherited cbZonas: TDBLookupComboBox
            Top = 197
            KeyField = 'ID'
            ListField = 'descripcion'
            ListSource = dsZonas_
      ...
      inherited tsContactos: TTabSheet
        ...
        inherited paContactos: TPanel
          ...
          ExplicitWidth = 545
          ExplicitHeight = 231
          inherited dgTelefonosContactos: TDBGrid
            Left = 260
            Top = 84
            Columns = <
              item
  ...
  inherited TCapturar: TIBTable
    ...
    IndexFieldNames = 'ID'
    MasterFields = 'R_ID'
    MasterSource = frmExplorar_vendedores.dsFuente
    StoreDefs = True
  ...
  inherited ilImagenes: TImageList
    Left = 244
    Bitmap = {
      494C0101040009001C0020002000FFFFFFFFFF10FFFFFFFFFFFFFFFF424D3600
