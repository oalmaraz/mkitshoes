object frmSeleccionarPedidos: TfrmSeleccionarPedidos
  Left = 276
  Top = 201
  ...
  object qyBusqueda: TIBQuery
    ...
    SQL.Strings = (
        ...
        'SELECT P.ID, P.CONSECUTIVO, P.CLAVE, S.NOMBRE, S.RAZON_SOCIAL, P' +
        '.DESCUENTO_GLOBAL_PORC, P.GRANTOTAL,  P.PRIORIDAD, P.ESTATUS'
      'FROM PEDIDOS P, SUJETOS_CLIENTES SC, SUJETOS S'
      'WHERE (P.CLIENTE = SC.ID) AND (SC.SUJETO = S.ID)')
    Left = 208
    Top = 128
  ...
  object spADD_PPEDIDOS_NC: TIBStoredProc
    Database = IBDatabase1
    Transaction = IBTransaction1
    StoredProcName = 'ADD_PPEDIDOS_NC'
    Left = 240
    Top = 224
    ParamData = <
      item
