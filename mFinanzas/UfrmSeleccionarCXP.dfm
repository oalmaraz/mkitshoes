object frmSeleccionarCXP: TfrmSeleccionarCXP
  Left = 308
  Top = 224
  Caption = 'Seleccionar Cuentas X Pagar'
  ClientHeight = 0
  ClientWidth = 124
  Color = clBtnFace
  ...
  object qyBusqueda: TIBQuery
    ...
    SQL.Strings = (
        ...
        'SELECT CXP.ID, CXP.REFERENCIA, CXP.PROVEEDOR, CXP.NUMERO_DE_DOCU' +
        'MENTOS, CXP.DOCUMENTO, CXP.FECHA_VENCIMIENTO, CXP.TOTAL, CXP.SAL' +
        'DO_ACTUAL, S.NOMBRE, S.RAZON_SOCIAL, S.FACTURAR_A'
      'FROM CUENTAS_X_PAGAR CXP, SUJETOS_PROVEEDORES SP, SUJETOS S'
      
        'WHERE (CXP.PROVEEDOR = SP.ID) AND (SP.SUJETO = S.ID) AND (CXP.ES' +
        'TATUS = "Pendiente de Pago")')
    Left = 208
    Top = 128
    ...
    object qyBusquedaPROVEEDOR: TIntegerField
      FieldName = 'PROVEEDOR'
      Required = True
    end
    ...
    object qyBusquedaTOTAL: TFloatField
      FieldName = 'TOTAL'
      DisplayFormat = '$ ###,###,##0.00'
    end
    object qyBusquedaSALDO_ACTUAL: TFloatField
