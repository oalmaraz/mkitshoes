...
uses
  ...
  IBX.IBStoredProc, IBX.IBTable,  IBX.IBCustomDataSet, IBX.IBQuery, Mask,    jpeg,
...
begin
  ...
  dsFuente.DataSet.FieldByName('POS_NIVEL').AsInteger            := clasifacionMaterial;
...
procedure TfrmCapturar_materiales.ibGuardarClick(Sender: TObject);
begin
  dsFuente.DataSet.FieldByName('POS_NIVEL').AsInteger            := clasifacionMaterial;
  // ShowMessage(IntToStr(clasifacionMaterial));
  inherited;
