  ...
  explorarMDI, Db,      Menus,
    IBX.IBCustomDataSet, IBX.IBQuery,
     StdCtrls, Mask, DBCtrls,
      jpeg, ExtCtrls,
    Buttons, IBX.IBStoredProc, ComCtrls, Grids, DBGrids, cxGraphics, cxControls,
...
type
  TfrmExplorar_materiales = class(TfrmExplorarMDI)
    ...
    dgExplorarDBTableView1R_CANTIDAD_MINIMA: TcxGridDBColumn;
    dgExplorarDBTableView1R_CANTIDAD_MAXIMA: TcxGridDBColumn;
    dgExplorarDBTableView1R_PREORDEN: TcxGridDBColumn;
    dgExplorarDBTableView1R_X_CAJA: TcxGridDBColumn;
    dgExplorarDBTableView1R_ST: TcxGridDBColumn;
    dgExplorarDBTableView1R_COSTO: TcxGridDBColumn;
    dgExplorarDBTableView1R_CB: TcxGridDBColumn;
    dgExplorarDBTableView1R_CANTIDAD1: TcxGridDBColumn;
    dgExplorarDBTableView1R_CANTIDAD2: TcxGridDBColumn;
    dgExplorarDBTableView1R_ESPRODUCTO: TcxGridDBColumn;
    dgExplorarDBTableView1R_SUJETO_A_MED: TcxGridDBColumn;
    dgExplorarDBTableView1R_AFECTA_INVENTARIO: TcxGridDBColumn;
    dgExplorarDBTableView1R_POS_CORTA: TcxGridDBColumn;
    dgExplorarDBTableView1R_POS_NIVEL: TcxGridDBColumn;
    dgExplorarDBTableView1R_ES_CATEGORIA: TcxGridDBColumn;
    dgExplorarDBTableView1R_ES_MODIFICADOR: TcxGridDBColumn;
    dgExplorarDBTableView1R_LARGO: TcxGridDBColumn;
    dgExplorarDBTableView1R_ALTO: TcxGridDBColumn;
    dgExplorarDBTableView1R_ANCHO: TcxGridDBColumn;
    dgExplorarDBTableView1R_CALIBRE: TcxGridDBColumn;
    dgExplorarDBTableView1R_LINEA_D: TcxGridDBColumn;
...
procedure TfrmExplorar_materiales.FormShow(Sender: TObject);
begin
  inherited;
  edExplorarValor.Visible:=false;
end;

procedure TfrmExplorar_materiales.ibVerClick(Sender: TObject);
begin
//  inherited;
  qyExplorar.close;
  ...
  qyExplorar.sql.add(' WHERE M.POS_NIVEL < 2  ');
  qyExplorar.Open;
