object frmAddPrepoliza: TfrmAddPrepoliza
  Left = 817
  Top = 247
  ...
  object cbPrepolizas: TDBLookupComboBox
    Left = 15
    Top = 30
    Width = 274
    Height = 21
  ...
  object dsPrepolizas: TDataSource
    DataSet = qyPrepolizas
    Left = 70
    Top = 64
  end
  object qyAdd: TIBQuery
    Database = dmIBModulo.ibSistema
    Transaction = dmIBModulo.ibSistemaTransaccion
    BufferChunks = 1000
    CachedUpdates = False
    ...
    SQL.Strings = (
      'SELECT *'
      'FROM A_PREPOLIZA_POLIZA(:P_CHEQUE, :P_PREPOLIZA)')
    Left = 104
    Top = 64
    ParamData = <
      item
