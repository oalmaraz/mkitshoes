object MarcoMateriales: TMarcoMateriales
  ...
  object paMateriales: TPanel
    ...
    object edCantidad: TcxCurrencyEdit
      Left = 395
      Top = 22
      TabOrder = 6
      Width = 81
    ...
    object edMaterial: TcxButtonEdit
      Left = 2
      Top = 25
      Properties.Buttons = <
        item
      ...
      Properties.OnButtonClick = edMaterialPropertiesButtonClick
      TabOrder = 19
    ...
    object edPrecioCosto: TcxCurrencyEdit
      Left = 544
      Top = 22
      TabOrder = 9
      Width = 84
    ...
    object edImpuesto1: TcxCurrencyEdit
      Left = 533
      Top = 63
      TabStop = False
      TabOrder = 17
    ...
    object edImpuesto2: TcxCurrencyEdit
      Left = 602
      Top = 63
      TabStop = False
      TabOrder = 18
    ...
    object edDescuentoPorc: TcxCurrencyEdit
      Left = 631
      Top = 22
      TabOrder = 10
      Width = 37
    end
    object edExistencia: TcxCurrencyEdit
      Left = 194
      Top = 2
      TabStop = False
      ParentFont = False
    ...
    object edOtros: TcxButtonEdit
      ...
      Properties.OnButtonClick = edOtrosButtonClick
      TabOrder = 2
      Width = 87
    end
