...
type
  TfrmExplorar_nombre_lista_precios = class(TfrmExplorarMDI)
    ...
    dgExplorarDBTableView1R_VIGENCIA_DIAS: TcxGridDBColumn;
    dgExplorarDBTableView1R_M_CLAVE: TcxGridDBColumn;
    dgExplorarDBTableView1R_M_DESCRIPCION: TcxGridDBColumn;
