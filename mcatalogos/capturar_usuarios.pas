...
uses
  ...
  Db, IBX.IBStoredProc, IBX.IBTable,  IBX.IBCustomDataSet, IBX.IBQuery,
...
procedure TfrmCapturar_usuarios.BitBtn1Click(Sender: TObject);
begin
  inherited;
  {
  frmAsigna_determinaciones := TfrmAsigna_determinaciones.Create(Application);
  frmAsigna_determinaciones.crear(dsFuente.DataSet.FieldByName('ID').AsInteger);
  frmAsigna_determinaciones.ShowModal;
  frmAsigna_determinaciones.Free;
  }
end;
